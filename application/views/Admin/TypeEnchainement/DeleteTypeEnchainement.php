  ...
  <div class="dialog-overlay">
    <div class="dialog-box">
      ...
      <div class="dialog-buttons">
        <a href="<?php echo base_url("ControllerAdmin/supprimerTypeEnchainement?idTypeEnchainement=".$idTypeEnchainement)?>"> Oui </a>
        <a href="<?php echo base_url("ControllerAdmin/annulerTypeEnchainement") ?>"> Non </a>
      </div>
    </div>
  </div>
